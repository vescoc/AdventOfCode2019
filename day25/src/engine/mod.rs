...
impl Engine {
    ...
    pub fn save_checkpoint(&mut self, _checkpoint_name: String) {
        todo!()
    }

    pub fn load_checkpoint(&mut self, _checkpoint_name: String) -> Result<(), LoadCheckpointError> {
        todo!()
    }
...
";
        ...
        assert_eq!(
            captures.name("room_name").expect("room_name").as_str(),
            "Hull Breach"
        );
        ...
        assert_eq!(
            captures.name("doors").expect("doors").as_str(),
            r"Doors here lead:
- east
- south
- west
...
"
        ...
        assert_eq!(
            captures.name("items").expect("items").as_str(),
            r"Items here:
- photons
"
        );
...
";
        ...
        assert_eq!(
            captures.name("description").expect("description").as_str(),
            "You don't have that item.\n"
        );
    }
}
